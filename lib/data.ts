...
// The live site now reads from data/content.json via lib/content-reader.ts,
// which is managed through the /dashboard CMS.
//
...
When I'm not coding, you can find me exploring new technologies, contributing to open-source projects, or sharing my knowledge through blog posts and mentoring.`,
    ...
    contact: {
      ...
      "phone": "",
      "location": "Narayanghat,Bharatpur-03,Chitwan,Bagmati,Nepal",
    ...
    social: {
      ...
      "medium": "",
      "devto": "",
      "portfolio": "https://www.farhanalam.com.np"
    },
